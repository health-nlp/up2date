...
# Up2Date Task 1 Training Package
...
Task 1 asks systems to predict the publication date of the next update of a
systematic review.
...
tira-cli dataset-submission \
  --path datasets-for-tira/up2date-task-1-training \
  --task up2date \
  --split test \
  --dry-run
```
